...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				'key' => 'field_588bd835cac25',
				'label' => 'Heading / Title',
				'name' => 'heading',
				'type' => 'text',
				'instructions' => 'This will be the title that is displayed at the top of the page',
